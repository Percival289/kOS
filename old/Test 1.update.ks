...
// TODO: Send status to another processor
...
function doThrottleManage {
    if abs(targetAP - ship:apoapsis) <= 100 {
        set throttleVar to 0.02 + 0.00143262 * abs(targetAP - ship:apoapsis) + 0.000018 * abs(targetAP - ship:apoapsis) ^ 2.
    } else {
